...
/datum/decorator/weapon_map_decorator/desert
	...
	map_array = list(MAP_WHISKEY_OUTPOST, MAP_DESERT_DAM, MAP_DESERT_DAM_AI, MAP_BIG_RED, MAP_BIG_RED_AI, MAP_KUTJEVO, MAP_KUTJEVO_AI)
...
/datum/decorator/weapon_map_decorator/snow
	...
	map_array = list(MAP_CORSAT, MAP_SOROKYNE_STRATA, MAP_ICE_COLONY, MAP_ICE_COLONY_V3, MAP_SOROKYNE_STRATA_AI)
