...
var/global/list/ROLES_AI			= list(JOB_CO, JOB_XO, JOB_SO, JOB_PILOT, JOB_CREWMAN, JOB_SYNTH, JOB_WORKING_JOE, JOB_CORPORATE_LIAISON, JOB_CHIEF_REQUISITION, JOB_CARGO_TECH, JOB_CMO, JOB_DOCTOR, JOB_NURSE, JOB_SQUAD_LEADER, JOB_SQUAD_RTO, JOB_SQUAD_SPECIALIST, JOB_SQUAD_SMARTGUN, JOB_SQUAD_MEDIC, JOB_SQUAD_ENGI, JOB_SQUAD_MARINE)
