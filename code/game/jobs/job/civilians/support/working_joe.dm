/datum/job/civilian/working_joe
	...
	flags_startup_parameters = ROLE_ADD_TO_DEFAULT|ROLE_CUSTOM_SPAWN|ROLE_WHITELISTED
...
/datum/job/civilian/working_joe/announce_entry_message(mob/living/carbon/human/H)
	addtimer(CALLBACK(GLOBAL_PROC, .proc/all_hands_on_deck, "ARES has deployed [H.real_name] to help with operations."), 1.5 SECONDS)
	return ..()
